CodePen does not support uploading images so we have to link directly to the file on the web. Use the following instructions to add a preselected image to your webpage.
